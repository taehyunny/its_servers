...
#define LIBS_SYS "-ldl -lm -lssl -lcrypto"
#define CFLAGS  INCLUDE
#define VERSION "10.8.8"
#define CC_VERSION "3.3.17"
#define PLUGIN_DIR "%s/lib/mariadb/plugin"
#define SOCKET  "/tmp/mysql.sock"
#define PORT "3306"
#ifdef HAVE_TLS
#define TLS_LIBRARY_VERSION "OpenSSL 3.0.13"
#else
...
#ifdef HAVE_EMBEDDED
#define EMBEDDED_LIBS "-L/usr/local/lib/ -lmariadbd -ldl -lm -lssl -lcrypto"
#endif
